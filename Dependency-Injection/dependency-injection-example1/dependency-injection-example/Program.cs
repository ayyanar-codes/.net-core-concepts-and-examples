 ...
 */
builder.Services.Add(new ServiceDescriptor(typeof(ILog), new DefaultLog(), ServiceLifetime.Singleton));  //share single instance throughout the application life time
